...
class JadwalPendakianController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('pages.admin.jadwal-pendakian.index',[
            'items' => $items,
        ]);
    }
    ...
    public function jadwalpendakianimport(Request $request){
        ...
        return redirect()->route('jadwal-pendakian.index');

    }
    public function create()
    {
        $destinasi_detail = DestinasiDetail::all();
        return view('pages.admin.jadwal-pendakian.create',[
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.jadwal-pendakian.edit',[
            'item' => $item,
            'destinasi_detail' => $destinasi_detail
        ]);
    }
